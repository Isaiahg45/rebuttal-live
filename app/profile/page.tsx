...
const { buddies, pendingReceived, pendingSent, acceptRequest, declineRequest, removeBuddy } = useBuddies(profile?.username ?? '', profile?.unlimited_buddies ?? false)const [soundEnabled, setSoundEnabled] = useState(true)
