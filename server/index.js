...
setInterval(() => {
  ...
  Object.values(rooms).forEach(room => {
    ...
    if (room.type === 'vc') {
     ...
     // No overall room-duration timer for VC debates — ending is handled
      // purely by turn count (5 rounds each = 10 turns total, see the
      // turnNumber > 10 check inside vc_turn_complete). The per-turn 90s
      // clock is separate and is what the client should be counting down.
